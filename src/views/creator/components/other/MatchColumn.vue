   ...
   <div>
      <div class="flex flex-col space-y-1  divide-y justify-center">
         <div class="p-2 flex space-x-2 items-center" v-for="c in selectedTable?.columns" :key="c.id">
            ...
            <MatchColumnSelect :item="c" :selected="item.selected" :default_checked="getDefaultChecked(c.name)" @checked="checked = $event"/> 
...
import MatchColumnSelect from '../form/matchColumnSelect.vue';
